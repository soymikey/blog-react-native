...
class ModalComponent extends Component {
  ...
  selectCategory(value) {
    const isSelected = this.state.categoryList.find(o => o.selected === true);

    if (isSelected) {
      this.alert("分类", "分类最多可以选择一个");
      return;
    }
  ...
  selectTag(value) {
    const isSelected = this.state.tagList.find(o => o.selected === true);

    if (isSelected) {
      this.alert("标签", "标签最多可以选择一个");
      return;
    }
